...
interface AccountRegistryInterface {
  function accountIdForAddress(address _address) external view returns (uint256);
  function addressBelongsToAccount(address _address) external view returns (bool);
