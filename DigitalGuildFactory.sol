...
constructor(string memory _guildSymbol, string memory _guildName, string memory _guildManifesto, uint _guildTribute, address _guildMaster, address _guildTreasury) public {
...
contract DigitalGuildFactory {
  ...
  function newDigitalGuild(string memory _guildSymbol, string memory _guildName, string memory _guildManifesto, uint _guildTribute, address _guildMaster, address _guildTreasury)
    public
    returns(address newContract)
  {
    DigitalGuild c = new DigitalGuild(_guildSymbol, _guildName, _guildManifesto, _guildTribute, _guildMaster, _guildTreasury);
    contracts.push(c);
    return c;
  }
}
